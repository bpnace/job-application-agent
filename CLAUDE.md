...
Before any public push, visibility change, tag or release, follow the non-optional publication gate in [AGENTS.md](AGENTS.md) and [docs/publication-safety.md](docs/publication-safety.md). Never infer privacy from `.gitignore` or the current branch alone.
